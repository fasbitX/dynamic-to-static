...
function sendEmail($config, $old_ip, $new_ip)
{
    ...
    if (!empty($config->notification_send_email)) {
        $mail = new PHPMailer\PHPMailer\PHPMailer(true);
        try {

            $mail_host = $config->notification_host;
            $from_email = $config->notification_from_email;
            $from_password = $config->notification_from_password;
            $from_name = $config->notification_from_name;
            $to_email = $config->notification_to_email;
            $to_name = $config->notification_to_name;
